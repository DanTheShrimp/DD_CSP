...
if randint == 1:
    ...
    print(f"The legendary {noun1} is in the {adjective1} hands of the evil {noun2} that will stop at nothing to {adverb1} {verb2} the world.")

elif randint == 3:
    print(f"You must rescue the {adjective1} king from the {adverb1}, evil {noun1}, which will destroy the {noun2} if you do not stop them.")

elif randint == 4:
    print(f"I, the {adjective1} {noun1}, will protect you, my {adverb1} {verb1} {noun2}, lest you {verb2} away from me.")

elif randint == 5:
    print(f"You are renouned {adjective1} {noun1}, who always manages to send those {adverb1} {verb1} {noun2}s running.")